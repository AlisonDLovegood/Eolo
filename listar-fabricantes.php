    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="principal-admin.php"><i class="fas fa-tasks"></i>Fabricantes</a>
        ...
        <!-- left sidebar -->
        <!-- ============================================================== -->
        <div class="nav-left-sidebar sidebar-dark" id="menuesq">
            <div class="menu-list">
...
if(isset($_GET['excluir'])) {
    $codigo = $_GET['excluir'];
    $consulta2 = $MySQLi->query("DELETE FROM TB_FABRICANTES
    WHERE FAB_CODIGO = $codigo");
    header("Location: listar-fabricantes.php");
}
$consulta = $MySQLi->query("SELECT * FROM TB_FABRICANTES");
?>
<html>
 <head>
      <title>Banco_dos_Fabricantes</title>
      <meta charset="utf-8">
    ...
    <table class="table" id="map">
        ...
        <tbody>         
            ...
            <tr>
                ...
                <td><a href="fabricante-editar.php?codigo=<?PHP echo $resultado['fab_codigo']; ?>"><i class="fas fa-edit"></i></a></td>
            </tr>
            <?php } ?>
        </tbody>
    </table>
     ...
     <center><li class="nav-item" id="lista">
                                            <a style="color: white;" class="nav-link" href="#" data-toggle="modal" data-target="#cadastrarfabricante">Cadastrar Novo</a>
                                        </li></center>
