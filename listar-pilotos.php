    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="principal-admin.php"><i class="fas fa-tasks"></i>Pilotos</a>
...
if(isset($_GET['excluir'])) {
    $codigo = $_GET['excluir'];
    $consulta2 = $MySQLi->query("DELETE FROM TB_PILOTOS
    WHERE PIL_CODIGO = $codigo");
    header("Location: listar-pilotos.php");
}
$consulta = $MySQLi->query("SELECT * FROM TB_PILOTOS");
?>
<html>
 <head>
      <title>Banco_dos_Pilotos</title>
      <meta charset="utf-8">
    ...
    <table class="table" id="map">
        ...
        <tbody>         
            ...
            <tr>
                ...
                <td><a href="pilotos-editar.php?codigo=<?PHP echo $resultado['pil_codigo']; ?>"><i class="fas fa-edit"></i></a></td>
            </tr>
            <?php } ?>
        </tbody>
    </table>
        ...
        <center><li class="nav-item" id="lista">
                                            <a style="color: white;" class="nav-link" href="#" data-toggle="modal" data-target="#cadastrarpiloto">Cadastrar Novo</a>
                                        </li></center>
