    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="principal-admin.php"><i class="fas fa-tasks"></i>Aeroportos</a>
        ...
        <div class="nav-left-sidebar sidebar-dark">
            <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 100%;"><div class="menu-list" style="overflow: hidden; width: auto; height: 100%; background: rgb(14,12,40);">
                <nav class="navbar navbar-expand-lg navbar-light" class="divlouca" style="background: rgb(14,12,40);">
                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                ...
                                <div id="submenu-1" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="listar-aeroportos.php">Listar aeroportos</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="listar-aeronaves.php">Listar aeronaves</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-3" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="listar-voos.php">Listar voos</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-4" aria-controls="submenu-4"><i class="fab fa-fw fa-wpforms"></i>Fabricantes</a>
                                <div id="submenu-4" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="listar-fabricantes.php">Listar fabricantes</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-5" aria-controls="submenu-5"><i class="fas fa-fw fa-table"></i>Empresas</a>
                                <div id="submenu-5" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="listar-empresas.php">Listar empresas</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li class="nav-item">
                                ...
                                <div id="submenu-6" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="listar-pilotos.php">Listar pilotos</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
...
if(isset($_GET['excluir'])) {
    $codigo = $_GET['excluir'];
    $consulta2 = $MySQLi->query("DELETE FROM TB_AEROPORTOS
    WHERE aer_codigo = $codigo");
    header("Location: listar-aeroportos.php");
}
$consulta = $MySQLi->query("SELECT * FROM TB_AEROPORTOS");
?>
<html>
 <head>
      <title>Banco_dos_Aeroportos</title>
      <meta charset="utf-8">
 ...
 <body>
    <table class="table" id="map">
        <thead class="thead-dark" id="cabecalho">
        ...
        <tbody>         
            ...
            <tr>
                ...
                <td><a href="aeroporto-editar.php?codigo=<?PHP echo $resultado['aer_codigo']; ?>"><i class="fas fa-edit"></i></a></td>
            </tr>
            <?php } ?>
        </tbody>
    </table>
    <center><li class="nav-item" id="lista">
                                            <a style="color: white;" class="nav-link" href="#" data-toggle="modal" data-target="#cadastraraeroporto">Cadastrar Nova</a>
                                        </li></center>
