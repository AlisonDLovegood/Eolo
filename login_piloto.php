...
if(isset($_POST['username'])) {
	...
	TB_PILOTOS where PIL_NOME = '$nome'
	and PIL_SENHA = '$senha'");
	if($resultado = $consulta->fetch_assoc()){
		$_SESSION['pilcod'] =
			$resultado['PIL_CODIGO'];
		$_SESSION['pilnome'] =
			$resultado['PIL_NOME'];
		header("Location: principal-piloto.php");
	}
	$msg = 1;
} 
?>
        ...
        <div class="col-sm-8 main-section">
            <div class="modal-content">
                <div class="col-12 user-img">
                    <img src="images/usere.png" th:src="@{/img/usere.png}"/>
                </div>
                <form class="col-12" action="?" method="POST">
                    <div class="alert alert-warning" role="alert">
                          <i class="fas fa-exclamation-circle"></i><strong>Apenas pilotos cadastrados pelas empresas!</strong>
                    </div> 
