    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="principal-admin.php"><i class="fas fa-tasks"></i>Voos</a>
...
if(isset($_GET['excluir'])) {
    $codigo = $_GET['excluir'];
    $consulta2 = $MySQLi->query("DELETE FROM TB_VOOS
    WHERE voo_id = $codigo");
    header("Location: listar-voos.php");
}
$consulta = $MySQLi -> query ("SELECT * FROM tb_voos");
 ?>
    ...
    <table class="table" id="map">
        ...
        <tbody>         
            ...
            <tr>
                ...
                <td><a href="voo-editar.php?codigo=<?PHP echo $resultado['voo_id']; ?>"><i class="fas fa-edit"></i></a></td>
            </tr> <?php } ?>
        </tbody>
    </table>

         <center><li class="nav-item" id="lista">
                                            <a style="color: white;" class="nav-link" href="#" data-toggle="modal" data-target="#cadastrarvoo">Cadastrar Nova</a>
                                        </li></center>
