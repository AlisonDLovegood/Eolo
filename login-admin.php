...
if(isset($_POST['username'])) {
    ...
    TB_ADMINISTRADORES where ADM_NOME = '$username'
    and ADM_SENHA = '$password'");
    if($resultado = $consulta->fetch_assoc()){
        $_SESSION['usucod'] =
            $resultado['ADM_CODIGO'];
        $_SESSION['usunome'] =
            $resultado['ADM_NOME'];
        ...
        <div class="col-sm-8 main-section">
            <div class="modal-content">
                <div class="col-12 user-img">
                    <img src="images/adm.png" th:src="@{/img/uuser.png}"/>
                </div>
                <form class="col-12" action="?" method="POST">
                    <div class="alert alert-warning" role="alert">
                          <i class="fas fa-exclamation-circle"></i><strong>Apenas Administradores!</strong>
                    </div>    
