    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="principal-admin.php"><i class="fas fa-tasks"></i>Empresas</a>
...
if(isset($_GET['excluir'])) {
    $codigo = $_GET['excluir'];
    $consulta2 = $MySQLi->query("DELETE FROM TB_EMPRESAS
    WHERE FAB_CODIGO = $codigo");
    header("Location: listar-empresas.php");
}
$consulta = $MySQLi->query("SELECT * FROM TB_EMPRESAS");
?>
<html>
 <head>
      <title>Banco_das_Empresas</title>
      <meta charset="utf-8">
    ...
    <table class="table" id="map">
        ...
        <tbody>         
            ...
            <tr>
                ...
                <td><a href="empresa-editar.php?codigo=<?PHP echo $resultado['emp_codigo']; ?>"><i class="fas fa-edit"></i></a></td>
            </tr>
            <?php } ?>
        </tbody>
    </table>
